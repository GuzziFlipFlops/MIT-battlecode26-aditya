    ...
    public static void run() {
        try {
            if (Globals.roundNum % 10 == 0) {
                System.out.println("[Hermesv7] Turn " + Globals.roundNum + ": RatKing at " + Globals.myLoc + ", Cheese: " + Globals.rc.getAllCheese());
            }
            ...
            System.out.println("[Hermesv7] ERROR in RatKingRunner: " + e.getMessage());
            e.printStackTrace();
        }
    }
