...
public class Globals {
    ...
    public static MapLocation[] knownCheeseLocations = new MapLocation[4];
    public static int numKnownCheeseLocations = 0;
    ...
    public static MapLocation[] knownCats = new MapLocation[10];
    public static int numKnownCats = 0;
    ...
    public static MapLocation[] getLocations(RobotInfo[] robots) {
        if (robots == null) return new MapLocation[0];
        MapLocation[] locs = new MapLocation[robots.length];
        int idx = 0;
        for (RobotInfo r : robots) {
            if (r != null) {
                locs[idx++] = r.getLocation();
            }
        }
        if (idx == locs.length) return locs;
        MapLocation[] trimmed = new MapLocation[idx];
        System.arraycopy(locs, 0, trimmed, 0, idx);
        return trimmed;
    }
