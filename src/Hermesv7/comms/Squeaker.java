...
public class Squeaker {
    ...
    public static void squeakAttack(MapLocation targetLoc) throws GameActionException {
        ...
        Globals.rc.squeak(message);
        System.out.println("[DEBUG Squeaker] Rat #" + Globals.myID + " SQUEAKED ATTACK at " + targetLoc + "!");
    }
    public static void processIncomingSqueaks() throws GameActionException {
        ...
        System.out.println("[DEBUG Squeaker] Rat #" + Globals.myID + " received " + squeaks.length + " squeaks");
        ...
        for (int i = 0; i < squeaks.length && Clock.getBytecodesLeft() > 500; i++) {
            ...
            if (type == SQUEAK_DANGER) {
                System.out.println("[DEBUG Squeaker] Rat #" + Globals.myID + " heard DANGER squeak at " + loc);
                ...
                System.out.println("[DEBUG Squeaker] Rat #" + Globals.myID + " heard ATTACK squeak at " + loc);
                ...
                for (int j = 0; j < enemies.length; j++) {
                    if (enemies[j] != null && enemies[j].getLocation().equals(loc)) {
                        ...
                        System.out.println("[DEBUG Squeaker] Rat #" + Globals.myID + " responding to ATTACK squeak! Moving to " + loc);
                        return;
                    }
                }
                ...
                if (knownEnemyKing != null && knownEnemyKing.equals(loc)) {
                    BabyRatState.setState(BabyRatStateType.ATTACKING_ENEMY);
                    BabyRatState.setTargetKing(loc);
                    System.out.println("[DEBUG Squeaker] Rat #" + Globals.myID + " responding to ATTACK squeak on enemy king! Moving to " + loc);
                    return;
                }
            }
        }
