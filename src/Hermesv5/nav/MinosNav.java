...
import Hermesv5.fast.FastIntSet;
import Hermesv5.fast.FastQueue;
...
public class MinosNav extends BugNav {
    ...
    static RobotInfo[] visibleEnemies = Globals.nearbyEnemies;
    static Team ENEMY_TEAM = Globals.enemyTeam;
        ...
        try {
            ...
            for (int i = 8; i-- > 0;) {
                ...
                if (!rc.onTheMap(newLoc)) {
                    ...
                    updateMovement();
                    return true;
                } else if (rc.canSenseLocation(newLoc)) {
