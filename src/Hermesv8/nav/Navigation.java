...
import Hermesv8.fast.FastQueue;
public class Navigation {
    ...
    protected static MapInfo[] visibleTiles;
    ...
    public static void init(RobotController r) {
        ...
        visibleTiles = Globals.nearbyMapInfos;
        MAP_WIDTH = Globals.mapWidth;
        MAP_HEIGHT = Globals.mapHeight;
    ...
    protected static boolean passable(RobotController rc, Direction d) throws GameActionException {
        ...
        return rc.sensePassability(adjacentLocation) && rc.senseRobotAtLocation(adjacentLocation) == null;
    }
